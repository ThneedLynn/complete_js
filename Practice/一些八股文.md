...
### Iterables
这是一个概念，哪些可以被for...of 访问。If an object isn’t technically an array, but represents a collection (list, set) of something, then for..of is a great syntax to loop over it, so let’s see how to make it work.
